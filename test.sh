...
assert 6 'main(){a=3; a = a *2; a;}'
assert 12 'main(){a=3; b=2; c= a * b; c *2;}'
assert 6 'main(){abc = 4; d = 2; abc + d;}'
assert 6 'main(){ret = 4; urn =2; return ret + urn;}'
assert 3 'main(){return 3; return 4;}'
assert 2 'main(){if (0 == 0) return 2;}'
assert 13 'main(){a = 4; if (a / 2 == 2) return 13; return 20;}'
assert 8 'main(){a = 5; if (a / 2 == 1) a = a * 2; if (a / 2 == 2) a = a + 3; return a;}'
assert 1 'main(){if (0!=0) return 0; else return 1;}'
assert 8 'main(){a = 5; if (a / 2 == 1) a = a * 2; else a = a + 3; return a;}'
